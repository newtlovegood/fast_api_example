...
import CustomersService from '../DiaryService';

let diaryService = new CustomersService();
  ...
  render() {
    return (
      <div className={editorStyles.editor} onClick={this.focus}>
        ...
        <button onClick={diaryService.createPost({'title': '', 'content': this.state.editorState})}>Save a record</button>
      </div>
    );
  }
}